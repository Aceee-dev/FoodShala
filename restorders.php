...
if(empty($_SESSION['rest_id']))  //if usser is not login redirected baack to login page
{
            ...
            <section class="restaurants-page">
                <div class="container">
                    <div class="row">
						...
						$query_res= mysqli_query($db,"select * from users_orders where rs_id='".$_SESSION['rest_id']."'");
										  ...
										  while($row=mysqli_fetch_array($query_res))
										  {
                                            ...
                                            $cust_id=$row['u_id'];
                                            $val= mysqli_query($db,"select f_name,email,address from users where u_id='$cust_id'");
                                             $row1=mysqli_fetch_array($val);
						
							?>
												<tr>	
                                                <td data-column="Name"> <?php echo $row1['f_name']; ?></td>
                                                <td data-column="Email"> <?php echo $row1['email']; ?></td>
                                                <td data-column="address"> <?php echo $row1['address']; ?></td>
