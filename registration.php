...
if(isset($_POST['submit'] )) //if submit btn is pressed
{
	...
	$mql = "INSERT INTO users(username,f_name,l_name,email,phone,password,address,Preferences) VALUES('".$_POST['username']."','".$_POST['firstname']."','".$_POST['lastname']."','".$_POST['email']."','".$_POST['phone']."','".md5($_POST['password'])."','".$_POST['address']."','".$_POST['preferences']."')";
	mysqli_query($db, $mql);
							  ...
							  <form action="" method="post">
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Preferences</label>
                                       <input type="text" class="form-control" id="exampleInputEmail1"  name="preferences" placeholder="Veg/Non-veg">                                    </div>
                                 </div>
